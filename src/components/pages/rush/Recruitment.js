    ...
    return (
        <Box mt={12} mb={18} className={classes.root}>
            ...
            {/* <a href="https://www.facebook.com/events/1116329235984973" target="_blank" rel="noopener noreferrer">
                <img src={flyer} className={isMobile ? classes.coverMobile : classes.cover} alt="Winter Rush 2024"></img>
            </a> */}
            ...
            <Typography component="div" className={classes.paragraph} align="center">
                ...
                Lambda Phi Nu is a co-ed Business Leadership Fraternity founded at UC Irvine in 2010 for students seeking to develop their leadership potential and to foster their professional and personal growth. With over 300 Active and Alumni brothers, we are now actively recruiting for our Alpha Delta class!
                </Box>
                <Box mt={6} mb={6} fontSize="h6.fontSize">
                Many of our brothers began their college experiences feeling unsure of their potential. Through our development curriculum and lifelong support, they went on to become leaders in campus organizations and excel in internships and full-time roles at companies like Microsoft, Goldman Sachs, Deloitte, and more! If you're looking to grow professionally, be apart of a lifelong community, and leave your legacy on the UCI community, join us this fall and experience what you could accomplish with Lambda Phi Nu.
                </Box>
                <Box mt={6} mb={6} fontSize="h6.fontSize">
