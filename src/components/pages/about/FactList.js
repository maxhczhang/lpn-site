...
export const facts = [
    {
        answer: <Link component={RouterLink} to="/active-brothers" color="inherit" underline="none">210</Link>,
    ...
    {
        answer: <Link component={RouterLink} to="/campus-involvement" color="inherit" underline="none">32</Link>,
