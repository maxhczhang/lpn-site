...
export default function ActiveBrothers({ setPage }) {
    ...
    return (
        <Box mt={12} mb={16} className={classes.root}>
            ...
            <BrothersList brothers={directors} isCsuite={false} width={218} height={330}></BrothersList>
            ...
            <BrothersList brothers={brothers} isCsuite={false} width={218} height={330}></BrothersList>
        </Box>
    )
}
