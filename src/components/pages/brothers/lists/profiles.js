export const profiles = {
    ...
    Julian_Rachman: {
        ...
        emphasis: "",
        practice: "Technology",
        experience: ["Ripplink, Founder and CEO", "Type One Ventures, Venture Fellow", "Amazon Web Services, Professional Services Technical Consultant"],
        campusInvolvements: ["UBA, Vice President", "UBA, Company Relations Director", "MAISS, Mentor"],
    ...
    Karen_Ching: {
        ...
        emphasis: "",
        practice: "Education",
        experience: ["UCI Graduate Divison, Research Assistant", "UCI School of Education, Peer Assistant", "HomeTown Financial Services, Marketing Intern"],
        campusInvolvements: ["Marketing Association, Member Relations Director", "Lambda Phi Nu, Corporate Relations Director", "CALPRIG, Member"],
    ...
    Tiffany_Chan: {
        ...
        emphasis: "",
        practice: "Audit",
        experience: ["RSM, Assurance Intern", "RSM, SLP Attendant", "Galileo Learning, Team Leader"],
        campusInvolvements: ["UCI Dragon Boat, President", "Accouting Association, Mentor", "Lambda Phi Nu, Social Impact Director"],
    ...
    Tony_Zhou: {
        ...
        practice: "Risk",
        experience: ["EY, Business Consulting Intern", "RSM, Risk & Financial Advisory Pathways Program", "Grant Thornton, Grow with Grant Thornton SLP"],
    ...
    Ben_Fan: {
        ...
        campusInvolvements: ["Lambda Phi Nu, Information Systems Director", "Sports Business Association, Member"],
    ...
    David_Sonq: {
        ...
        emphasis: "Accounting",
        practice: "Tax",
        experience: ["EY, Tax Intern", "EY, KPMG, RSM, BDO, Summer Leadership Program", "Student Success Initiatives, International Peer Group Mentor"],
    ...
    Emily_Nguyen: {
        ...
        experience: ["New Relic, Talent & Organizational Development Intern", "Lumentum, WorkPlace Services Business Operations Intern", "Paul Merage School of Business, Specialty Masters Assistant"],
    ...
    Le_An_Pham: {
        ...
        emphasis: "Marketing",
        practice: "Marketing",
        experience: ["United Exchange Corporation, Marketing & Product Development Intern", "Sunwest Bank, Marketing Intern", "Polar Holidays, Digital Marketing Intern"],
    ...
    Sandy_Nguyen: {
        ...
        experience: ["MongoDB - Product Design Intern", "McAfee, Product Design Intern", "Goinvo, UX Designer Intern"],
    ...
    Tiffany_Wong: {
        ...
        experience: ["JP Morgan Chase & Co, Global Finance & Business Management Summer Analyst", "KPMG, Tax Intern", "Full Time MBA Program, Student Assistant"],
    ...
    Faith_Chia: {
        ...
        experience: ["The TJX Companies, Inc, Merchandising Intern", 'Merage Fully Employed MBA Program, Student Assistant', "Insomnia Cookies, Marketing Representative"],
    ...
    Joshua_Tong: {
        ...
        campusInvolvements: ["ASUCI Content Creation Commissioner", "MUSA, VP of Technology", "MAISS, Mentor"],
    ...
    Sahana_Vairavaraj: {
        ...
        experience: ["Capital One, HR Rotational Program Intern", "Baker Tilly, Tax Intern",  "Marcum, Assurance Intern"],
        campusInvolvements: ["Lambda Phi Nu, Chief Talent Officer", "Human Resources Management Association, VP of Operations", "Accounting Association, Mentor"],
    ...
    Sera_Xu: {
        ...
        campusInvolvements: ["UBA, Finance Director", "Accounting Association, Committee Board Officer", "UBA, Executive Board Intern"],
    ...
    Andrew_Duong: {
        ...
        campusInvolvements: ["Accounting Association, Committee Board Officer", "Accounting Association Leadership Development Program, Mentor"],
    ...
    Catherine_Nguyen: {
        ...
        emphasis: "Marketing",
        practice: "Marketing",
        experience: ["HashiCorp, Marketing Demand Generation Intern", "ViaLoop, Sales & Marketing Coordinator", "Fully Employed and Executive MBA Office, Student Assistant"],
        campusInvolvements: ["Panhellenic Association, VP of Scholarship", "MUSA, Representative", "Peace Corps, Campus Ambassador"],
    ...
    Ian_Han: {
        ...
        campusInvolvements: ["MAISS, VP of Marketing", "ASUCI, Concerts Commissioner", "ASUCI, Business Relations Intern"],
    ...
    Lucian_Liu: {
        ...
        campusInvolvements: ["UFA, Executive VP","MUSA, VP of Finance", "Lambda Phi Nu, Strategy Director"],
    ...
    Omar_Naji: {
        ...
        emphasis: "",
        practice: "Human Resources",
        experience: ["NUDA Juice & Wellness Shop, Marketing Strategy Intern", "Dance4Joy Ministries, Marketing Intern", "Bren Events Center, Crew Member"],
        campusInvolvements: ["LPN, Recruiter", "MAISS, Mentee", "Quokka Brew, Campus Ambassador"],
    ...
    Philip_Cheung: {
        ...
        campusInvolvements: ["MAISS, Mentor", "Lambda Phi Nu, Recruiter", "CASA, Member"],
    ...
    Raymond_Dinh: {
        ...
        experience: ["Agora Néos, Project Management Intern", "MENTOR Global Consulting, Management Consulting Intern", "eCommerce Solutionist, Director of Operations"],
        campusInvolvements: ["Phi Delta Theta, Phikeia Educator", "LPN, Associate Auditor", "MUSA, Student Representative"],
    ...
    Ryan_Miranda: {
        ...
        experience: ["Microsoft, Software Engineer Intern", "Vusar, Software Engineer Intern", "Math Enrichment, Teaching Assistant"],
        campusInvolvements: ["MAISS, VP of Professional Development", "LPN, Webmaster", "MAISS, Professional Development Intern"],
        interests: ["Playing guitar", "Cooking", "Peanut Butter", "TechCrunch", "Tesla"],
    ...
    Serina_Nguyen: {
        ...
        emphasis: "Marketing",
        practice: "Marketing",
        experience: ["Issuu, Marketing Projects Intern"],
        campusInvolvements: ["UFA, VP of Marketing", "Marketing Association, VP of Internal Affairs", "Lambda Phi Nu, Marketing Director"],
    ...
    Tyler_Newman: {
        ...
        campusInvolvements: ["Lambda Phi Nu, Culture & Relationships Director", "MAISS, VP of Community Development", "Kababayan, Treasurer"],
    ...
    Adrian_Siu: {
        ...
        experience: ["Urban Ritual Cafe, Bobarista", "Cashier, Uni Souffle"],
        campusInvolvements: ["UFA, VP of Technology", "MUSA, Representative", "Chinese Association, Member"],
    ...
    Cathy_Yun: {
        ...
        emphasis: "",
        practice: "Tax",
        experience: ["Holthouse Carlin & Van Trigt, Tax Intern", "BDO, Tax Intern", "Becker Professional Education, Campus Ambassador"],
        campusInvolvements: ["Accounting Association Leadership Development Program, Coordinator", "TEDxUCIrvine, Director of Finance", "FRESH Basic Needs Hub, Administrative Intern"],
    ...
    Haley_Kim: {
        ...
        practice: "Consulting",
        experience: ["BlackBerry, Managed Security Services Prodiver Intern", "Sizigi, Strategy Consulting Intern", "Bridgespace, Consultant"],
        campusInvolvements: ["ASUCI, Organizing Commission Staffer", "LPN, Talent Associate"],
    ...
    Jennifer_Lin: {
        ...
        emphasis: "",
        practice: "Human Resources",
        experience: ["Our Place Healing Hearts Foundation, K-12 Math Tutor", "Alamo Inn & Suites, HR Intern & Executive Assistant", "Orange Country Social Services Agency, Summer Intern"],
        campusInvolvements: ["Crossroads Campus Ministry, Inreach Team"],
    ...
    Julio_Cano: {
        ...
        emphasis: "",
        practice: "Marketing Strategy",
        experience: ["Real Estate Association, Intern",],
        campusInvolvements: ["Undergraduate/Undeclared Mentoring Program, Mentor", "Hispanic 100 Foundation, Member/ Scholarship recipient"],
    ...
    Kaylie_Zhou: {
        ...
        emphasis: "",
        practice: "Human Resources",
        experience: ["Twinkle Brown Sugar, Social Media Manager", "GaoTek Incorporated, Human Resources Intern", "The Economist, Campus Ambassador Representative"],
        campusInvolvements: ["Antleader Mentorship Program, Mentee"],
    ...
    Khoa_Tran: {
        ...
        emphasis: "Finance, Information Systems",
        practice: "Finance",
        experience: ["JPMorgan Chase & Co, Middle Market Banking & Specialized Industries Summer Analyst", "Executive Park Law Offices, Legal Assistant"],
        campusInvolvements: ["UFA, VP of Internal Affairs", "LPN, Operations Associate"],
    ...
    Naveen_Sastri: {
        ...
        experience: ["Instaboost Media, Marketing & PR Intern", "Cupertino Tennis Center, Instructor", "University of Oregon, Lab Assistant"],
        campusInvolvements: ["Tomo No Kai, Publicity & Social Media Intern", "LPN, Information Associate", "MAISS, Mentee"],
    ...
    Raj_Singh: {
        ...
        emphasis: "",
        practice: "Marketing",
        experience: ["Sencha Credit, Content Marketer", "Pioneer Tax & Accounting Services Inc, IT Receptionist", "Which Wich Superior Sandwiches, Associate Employee"],
        campusInvolvements: ["Marketing Association, External Affairs Intern", "MAISS, Mentee"],
    ...
    Vivian_Tran: {
        ...
        experience: ["Kanerani, Digital Marketing Intern", "Volt Solutions Workforces, Apple Technical Support Specialist"],
