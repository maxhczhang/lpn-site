export const fullTimes = {
    ...
    analytics: [
        { name: 'Dominic Wright', company: 'Paramount Residential Mortage Group', position: "Business Analytics", industry: "Analytics" },
        { name: 'Andrew Kusnohadi', company: 'Optum', position: "Competitive Intelligence", industry: "Analytics" },
    ]
};

export default { fullTimes };